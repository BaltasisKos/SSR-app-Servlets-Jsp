...
import gr.aueb.cf.schoolapp.model.Teacher;import gr.aueb.cf.schoolapp.service.CityServiceImpl;
...
public class StudentInsertController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        //req.getSession().setAttribute("insertDTO", studentInsertDTO);
...
//                req.getRequestDispatcher("/WEB-INF/jsp/students-insert.jsp")
//                        .forward(req, resp);

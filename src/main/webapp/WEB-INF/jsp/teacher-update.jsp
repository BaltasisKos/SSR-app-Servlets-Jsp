...
<main class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Επεξεργασία Στοιχείων Καθηγητή</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="firstname" name="firstname" type="text"
                               value="${requestScope.updateDTO.firstname}"
                    ...
                    <div>
                        ...
                        <input id="lastname" name="lastname" type="text"
                               value="${requestScope.updateDTO.lastname}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="fathername" name="fathername" type="text"
                               value="${requestScope.updateDTO.fatherName}"

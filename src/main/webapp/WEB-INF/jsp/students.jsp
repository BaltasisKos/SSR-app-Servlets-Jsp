                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <c:choose>
                        <c:when test="${not empty requestScope.students}">
                            <c:forEach var="teacher" items="${requestScope.students}">
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-right">
                                        <div class="flex justify-end space-x-3">
                                            <a href="${pageContext.request.contextPath}/school-app/students/view?id=${teacher.id}"
                                               class="text-primary-500 hover:text-primary-600 p-1 rounded-full hover:bg-primary-50 transition-colors duration-200"
                                               title="Προβολή">
                                                <i class="fas fa-eye w-5 h-5"></i>
                                            </a>
                                            <a href="${pageContext.request.contextPath}/school-app/students/update?id=${teacher.id}"
                                            ...
                                            <a href="${pageContext.request.contextPath}/school-app/students/delete?id=${teacher.id}"
